...
function AsideMenu({ menuItems, pathname: currentUrl }: SectionProps<typeof loader>) {
    const currentRoute = menuItems.find((item) => item.href === currentUrl);
    return (<aside class="md:min-w-[20%] font-medium text-secondary-focus flex md:justify-end">
      ...
      <div class="md:hidden w-full pb-5">
        <div class="dropdown w-full text-sm font-normal">
          <label tabIndex={0} class="btn btn-secondary btn-block bg-base-content justify-between border-none">
